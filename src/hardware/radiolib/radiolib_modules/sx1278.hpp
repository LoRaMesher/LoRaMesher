...
/**
 * @brief Implementation of IRadio interface for LoraMesher SX1278 using RadioLib
 *
 * This class provides a concrete implementation of the IRadio interface
 * specifically for the LoraMesher SX1278 radio module using the RadioLib library.
 ...
 * @see RadioLib::SX1278
 */
class LoraMesherSX1278 : public IRadio {
   public:
    /**
     * @brief Construct a new LoraMesher SX1278 radio instance
     *
     * Initializes a new LoraMesher SX1278 radio module with the specified pins.
    ...
    Result Configure(const RadioConfig& config) override {
        ...
        throw std::runtime_error("Configure not supported in LoraMesherSX1278");
    }
    ...
    Result setActionReceive(
        ...
        throw std::runtime_error(
            "setActionReceive not supported in LoraMesherSX1278");
    }
    ...
    float getLastPacketRSSI() override {
        throw std::runtime_error(
            "getLastPacketRSSI not supported in LoraMesherSX1278");
    }
    ...
    float getLastPacketSNR() override {
        throw std::runtime_error(
            "getLastPacketSNR not supported in LoraMesherSX1278");
    }
    ...
    bool IsTransmitting() override {
        throw std::runtime_error(
            "IsTransmitting not supported in LoraMesherSX1278");
    }
    ...
    float getFrequency() override {
        throw std::runtime_error(
            "getFrequency not supported in LoraMesherSX1278");
    }
    ...
    uint8_t getSpreadingFactor() override {
        throw std::runtime_error(
            "getSpreadingFactor not supported in LoraMesherSX1278");
    }
    ...
    float getBandwidth() override {
        throw std::runtime_error(
            "getBandwidth not supported in LoraMesherSX1278");
    }
    ...
    uint8_t getCodingRate() override {
        throw std::runtime_error(
            "getCodingRate not supported in LoraMesherSX1278");
    }
    ...
    uint8_t getPower() override {
        throw std::runtime_error("getPower not supported in LoraMesherSX1278");
    }
 ...
 */
    Result setState(RadioState state) override {
        ...
        throw std::runtime_error("setState not supported in LoraMesherSX1278");
    }
 ...
 */
    RadioState getState() override {
        throw std::runtime_error("getState not supported in LoraMesherSX1278");
    }
   ...
   private:
    ...
    std::unique_ptr<SX1278>
        radio_module_;  ///< RadioLib LoraMesherSX1278 instance
