...
Result LoraMesherSX1268::InitializeHardware() {
#ifdef LORAMESHER_BUILD_ARDUINO
...
// TODO: Implement esp-idf HAL
    ...
    // Create RadioLib SX1268 instance
    radio_module_ = std::make_unique<SX1268>(hal_module_.get());
    if (!radio_module_) {
        return Result(LoraMesherErrorCode::kHardwareError,
                      "Something went wrong when initializing SX1268, check "
...
Result LoraMesherSX1268::Begin(const RadioConfig& config) {
    ...
    // Begin radio module with SX1268-specific parameters
    ...
    float limit = auto_current_limit_
                      ? RadioConfig::RecommendedCurrentLimit(RadioType::kSx1268,
                                                             config.getPower())
    ...
    // SX1268 uses uint8_t for CRC mode instead of bool
...
Result LoraMesherSX1268::Send(const uint8_t* data, size_t len) {
    if (!initialized_) {
...
Result LoraMesherSX1268::StartReceive() {
    if (!initialized_) {
        return Result::Error(LoraMesherErrorCode::kNotInitialized);
    }
...
Result LoraMesherSX1268::Standby() {
    if (!initialized_) {
        return Result::Error(LoraMesherErrorCode::kNotInitialized);
    }
...
Result LoraMesherSX1268::setFrequency(float frequency) {
    if (!initialized_) {
        return Result::Error(LoraMesherErrorCode::kNotInitialized);
    }
...
Result LoraMesherSX1268::setSpreadingFactor(uint8_t sf) {
    if (!initialized_) {
        return Result::Error(LoraMesherErrorCode::kNotInitialized);
    }
...
Result LoraMesherSX1268::setBandwidth(float bandwidth) {
    if (!initialized_) {
        return Result::Error(LoraMesherErrorCode::kNotInitialized);
    }
...
Result LoraMesherSX1268::setCodingRate(uint8_t coding_rate) {
    if (!initialized_) {
        return Result::Error(LoraMesherErrorCode::kNotInitialized);
    }
...
Result LoraMesherSX1268::setPower(int8_t power) {
    if (!initialized_) {
        return Result::Error(LoraMesherErrorCode::kNotInitialized);
    }
...
Result LoraMesherSX1268::setCurrentLimit(float current_limit_ma) {
    if (!initialized_) {
        return Result::Error(LoraMesherErrorCode::kNotInitialized);
    }
...
Result LoraMesherSX1268::setSyncWord(uint8_t sync_word) {
    if (!initialized_) {
        return Result::Error(LoraMesherErrorCode::kNotInitialized);
    }
...
Result LoraMesherSX1268::setCRC(bool enable) {
    if (!initialized_) {
        return Result::Error(LoraMesherErrorCode::kNotInitialized);
    }
...
Result LoraMesherSX1268::setPreambleLength(uint16_t length) {
    if (!initialized_) {
        return Result::Error(LoraMesherErrorCode::kNotInitialized);
    }
...
Result LoraMesherSX1268::setActionReceive(void (*callback)(void)) {
    if (!initialized_) {
        return Result::Error(LoraMesherErrorCode::kNotInitialized);
    }
...
Result LoraMesherSX1268::ClearActionReceive() {
    if (!initialized_) {
        return Result::Error(LoraMesherErrorCode::kNotInitialized);
    }
...
float LoraMesherSX1268::getRSSI() {
    if (!initialized_) {
        return 0.0f;
    }
...
uint8_t LoraMesherSX1268::getPacketLength() {
    if (!initialized_) {
        return 0;
    }
...
uint32_t LoraMesherSX1268::getTimeOnAir(uint8_t length) {
    if (!initialized_) {
        return 0;
    }
...
Result LoraMesherSX1268::readData(uint8_t* data, size_t len) {
    if (!initialized_) {
        return Result::Error(LoraMesherErrorCode::kNotInitialized);
    }
