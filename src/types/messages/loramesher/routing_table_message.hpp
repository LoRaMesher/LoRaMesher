...
/**
  ...
  * header information and contains a list of routing table entries.
  */
class RoutingTableMessage : public IConvertibleToBaseMessage {
   public:
    /**
      ...
      * @param network_id Identifier of the network
      * @param table_version Version of the routing table
      * @param entries Vector of routing table entries
    ...
    /**
      * @brief Gets the list of routing table entries
      * 
      * @return const std::vector<RoutingTableEntry>& The routing entries
      */
   ...
   private:
    ...
    std::vector<RoutingTableEntry> entries_;  ///< Routing table entries
};
